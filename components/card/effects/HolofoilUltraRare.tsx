  ...
  return (
    <>
      <div
        ...
        className={cn(
          "holofoil-ultra-rare absolute w-full h-full z-1",
          "[contain:paint] backface-hidden",
          "mix-blend-color-dodge",
          "will-change-[background-position]",
          "mask-[var(--mask)] mask-luminance mask-center mask-cover",
          "filter-[brightness(calc((var(--pointer-from-center)*0.4)+0.5))_contrast(2.5)_saturate(.66)]",
          ...
          "after:filter-[brightness(calc((var(--pointer-from-center)*0.4)+0.5))_contrast(1.66)_saturate(1)]",
      ...
      <Glare
        className={cn(
          "[background-image:radial-gradient(farthest-corner_circle_at_var(--pointer-x)_var(--pointer-y),hsl(0,0%,55%)_5%,hsl(200,5%,40%)_40%,hsl(200,10%,15%)_110%)]",
          "bg-cover",
          "filter-[brightness(1.25)_contrast(1.4)_saturate(1)]"
        )}
      />
    </>
  );
