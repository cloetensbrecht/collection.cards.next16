...
const ReverseHolofoilMasterBall: React.FC = () => {
  ...
  return (
    <div
      ...
      className={cn(
        "reverse-holofoil-master-ball absolute w-full h-full z-1",
...
export default ReverseHolofoilMasterBall;

export const ReverseHolofoilMasterBallAfterGlare: React.FC = () => {
  return (
    <div
      className={cn(
